...
import com.cunchugui.houtai.model.Message;
import com.cunchugui.houtai.utils.AlertUtil;
import com.cunchugui.houtai.utils.TimeCount;
        ...
        OkGo.<AppResponse>post(Urls.HOME_PICTURE_HOME)
                ...
                .execute(new JsonCallback<AppResponse>() {
                    ...
                    public void onSuccess(Response<AppResponse> response) {
                        ...
                        PreferenceHelper.getInstance(mContext).putString(ConstanceValue.CUNCHUBIND_WEIXINPAY, "2");
                    }
